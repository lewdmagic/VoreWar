...
internal class UniformData
{
    ...
    public void CopyFromUnit(Unit unit, bool hat, bool clothingAcc)
    {
        ...
        if (HatSaved) ClothingHatType = unit.ClothingHatType;
        if (ClothingAccesorySaved) ClothingAccesoryType = unit.ClothingAccessoryType;
    ...
    public void CopyToUnit(Unit unit)
    {
        ...
        if (HatSaved) unit.ClothingHatType = ClothingHatType;
        if (ClothingAccesorySaved) unit.ClothingAccessoryType = ClothingAccesoryType;
