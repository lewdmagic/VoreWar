...
static class StoredLogTexts
{
    ...
    internal static void InitializeLists()
    {
        ...
        bool TargetHumanoid(EventLog s) => RaceFuncs.isHumanoid(s.Target.Race);
        ...
        BellyRubMessages = new List<EventString>()
        {
            ...
            targetRace: Race.Dogs, priority: 9, conditional: s => Equals(s.Target.Side, s.Unit.Side) && ReqTargetCompatibleLewd(s)),
            ...
            targetRace: Race.Dogs, priority: 9, conditional: s => Equals(s.Target.Side, s.Unit.Side) && ReqTargetCompatibleLewd(s) && ActorHumanoid(s) && s.Target.GetGender() == Gender.Female),
            ...
            targetRace: Race.Cats, priority: 9, conditional: s => Equals(s.Target.Side, s.Unit.Side) && ReqTargetCompatible(s)),
            ...
            targetRace: Race.Cats, priority: 9, conditional: s => Equals(s.Target.Side, s.Unit.Side) && ReqTargetCompatibleLewd(s) && s.Target.GetGender() == Gender.Female),
            ...
            targetRace: Race.Cats, priority: 9, conditional: s => Equals(s.Target.Side, s.Unit.Side) && ReqTargetCompatibleLewd(s)),
            ...
            targetRace: Race.Cats, priority: 9, conditional: s => Equals(s.Target.Side, s.Unit.Side) && ReqTargetCompatibleLewd(s) && ActorHumanoid(s) && s.Target.GetGender() == Gender.Female),
            ...
            targetRace: Race.Wolves, priority: 9, conditional: s => Equals(s.Target.Side, s.Unit.Side) && ReqTargetCompatible(s)),
            ...
            targetRace: Race.Imps, priority: 9, conditional: s => Equals(s.Target.Side, s.Unit.Side) && ReqTargetCompatibleLewd(s) && ActorHumanoid(s)),
            ...
            targetRace: Race.Lizards, priority: 9, conditional: s => Equals(s.Target.Side, s.Unit.Side)),
            ...
            targetRace: Race.Lizards, priority: 9, conditional: s => Equals(s.Target.Side, s.Unit.Side) && ReqTargetCompatibleLewd(s)),
            ...
            targetRace: Race.Bunnies, priority: 9, conditional: s => Equals(s.Target.Side, s.Unit.Side)),
            ...
            targetRace: Race.Bunnies, priority: 9, conditional: s => Equals(s.Target.Side, s.Unit.Side) && ReqTargetCompatibleLewd(s)),
            ...
            targetRace: Race.Bunnies, priority: 9, conditional: s => Equals(s.Target.Side, s.Unit.Side) && ReqTargetCompatibleLewd(s) && ActorHumanoid(s)),
            ...
            targetRace: Race.Bunnies, priority: 9, conditional: s => Equals(s.Target.Side, s.Unit.Side) && ActorHumanoid(s)),
            ...
            targetRace: Race.Dogs, priority: 9, conditional: s => Equals(s.Target.Side, s.Unit.Side) && ReqTargetCompatibleLewd(s) && ActorHumanoid(s)),
            ...
            actorRace: Race.Kobolds, priority: 9, conditional: s => Equals(s.Target.Race, Race.Dragon) || Equals(s.Target.Race, Race.EasternDragon)),
        ...
        BreastRubMessages = new List<EventString>()
        {
            ...
            //succs
            new EventString((i) =>$"The mere touch of <b>{i.Unit.Name}</b> is enough to make <b>{i.Target.Name}</b> gasp and quiver in pleasure.", actorRace: Race.Succubi, priority: 9, conditional: s=> Equals(s.Target.Side, s.Unit.Side)),
            new EventString((i) =>$"<b>{i.Unit.Name}</b> moans and hugs <b>{i.Target.Name}</b> tightly and grinds their breasts against one another, sending tingling bliss down both their spines.", actorRace: Race.Succubi, priority: 9, conditional: s=> Equals(s.Target.Side, s.Unit.Side) && ReqTargetCompatibleLewd(s) && ActorBoobs(s)),
        };
        ...
        BallMassageMessages = new List<EventString>()
        {
            ...
            actorRace: Race.Kobolds, priority: 10, conditional: s => Lewd(s) && Equals(s.Target.Race, Race.Dragon) || Equals(s.Target.Race, Race.EasternDragon)),
            ...
            actorRace: Race.Kobolds, priority: 10, conditional: s => Equals(s.Target.Race, Race.Dragon) || Equals(s.Target.Race, Race.EasternDragon)),
        ...
        BreastVoreMessages = new List<EventString>()
        {
            ...
            new EventString((i) => $"<b>{i.Unit.Name}</b> approaches <b>{i.Target.Name}</b> and taps on {GPPHis(i.Target)} shoulder. <b>{i.Unit.Name}</b> then gestures to {GPPHis(i.Unit)} pouch, which {GPPHeIs(i.Unit)} holding open with {GPPHis(i.Unit)} fingers. After <b>{i.Target.Name}</b> reluctantly gets in, <b>{i.Unit.Name}</b>'s pouch's entrance closes somewhat above <b>{i.Target.Name}</b>, not enough to block oxygen from flowing in, but enough to stop <b>{i.Target.Name}</b> from just falling out.", actorRace: Race.Kangaroos, priority: 10, conditional: s=> (Equals(s.Target.Side, s.Unit.Side))),

            // Endo pouch vore
            new EventString((i) => $"<b>{i.Unit.Name}</b> approaches <b>{i.Target.Name}</b> and asks {GPPHim(i.Target)} to get in {GPPHis(i.Unit)} pouch, which <b>{i.Target.Name}</b> quickly does.", actorRace: Race.Kangaroos, priority: 10, conditional: s=> (Equals(s.Target.Side, s.Unit.Side))),
            new EventString((i) => $"As <b>{i.Unit.Name}</b> walks by <b>{i.Target.Name}</b>, <b>{i.Target.Name}</b> asks if {GPPHe(i.Target)} could hide in <b>{i.Unit.Name}</b>'s pouch for a bit, to which <b>{i.Unit.Name}</b> shrugs and says \"sure.\"", actorRace: Race.Kangaroos, priority: 10, conditional: s=> (Equals(s.Target.Side, s.Unit.Side))),
            new EventString((i) => $"<b>{i.Unit.Name}</b> approaches <b>{i.Target.Name}</b> and tells {GPPHim(i.Target)} to get in {GPPHis(i.Unit)} pouch. Not one to question orders, <b>{i.Target.Name}</b> gets in <b>{i.Unit.Name}</b>'s pouch.", actorRace: Race.Kangaroos, priority: 10, conditional: s=> (Equals(s.Target.Side, s.Unit.Side))),
            new EventString((i) => $"As <b>{i.Unit.Name}</b> approaches <b>{i.Target.Name}</b>, {GPPHe(i.Target)} surprises <b>{i.Unit.Name}</b> by jumping in {GPPHis(i.Unit)} pouch!", actorRace: Race.Kangaroos, priority: 10, conditional: s=> (Equals(s.Target.Side, s.Unit.Side))),
