...
namespace DaVikingCode.AssetPacker
{
    ...
    public class SpriteManager
    {
        ...
        {
            var res = CreatePack3(itemsToRaster, 2048, 160f);
...
*/
        ...
        private static List<Entry> CreatePack3(List<TextureToPack> itemsToRaster, int textureSize, float pixelsPerUnit)
        {
            List<Entry> entries = new List<Entry>();
        ...
        private void Save(string savePath, List<Entry> toSave)
        {
