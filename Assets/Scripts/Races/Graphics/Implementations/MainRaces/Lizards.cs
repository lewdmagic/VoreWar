    ...
    internal static class Lizards
    {
        ...
        internal static readonly RaceDataMaker Instance = RaceBuilderStatic.CreateV2(Defaults.Default, builder =>
        {
            ...
            builder.RandomCustom(data =>
            {
                ...
                {
                    unit.ClothingHatType = 1 + Extensions.IndexOf(data.SetupOutput.AllowedClothingHatTypes, RaceSpecificClothing.LizardLeaderCrownInstance);
                    unit.ClothingType = 1 + Extensions.IndexOf(data.SetupOutput.AllowedMainClothingTypes, RaceSpecificClothing.LizardLeaderTopInstance);
                    unit.ClothingType2 = 1 + Extensions.IndexOf(data.SetupOutput.AllowedWaistTypes, RaceSpecificClothing.LizardLeaderSkirtInstance);
                    unit.ClothingExtraType1 = 1 + Extensions.IndexOf(data.SetupOutput.ExtraMainClothing1Types, RaceSpecificClothing.LizardLeaderLegguardsInstance);
                    unit.ClothingExtraType2 = 1 + Extensions.IndexOf(data.SetupOutput.ExtraMainClothing2Types, RaceSpecificClothing.LizardLeaderArmbandsInstance);
                }
