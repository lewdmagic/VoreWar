...
public enum TraitType
{
    ...
    /// <summary>
    ///     When unit fails a vore attack, unit instead bites target, dealing damage equivalent to that of the basic melee
    ///     weapon.
    /// </summary>
    Biter = 42,
    ...
    /// <summary>
    ///     Unit may stun target for 1 turn when attacking. First stun is 10% chance, with lower chances the more time the
    ///     unit has been stunned.
    /// </summary>
    Paralyzer = 44,
    ...
    /// <summary>
    ///     Unit has a much greater chance to evade ranged attacks. (The exact math is complicated, but should decrease
    ///     hit chance by up to 50%.)
    /// </summary>
    KeenReflexes = 54,
    ...
    /// <summary>
    ///     Unit has two stomachs. Oral/anal prey will become trapped in second stomach after 2 turns, escaping second
    ///     stomach moves prey to first stomach and allows 7 turns to escape again before being moved back to second stomach.
    /// </summary>
    DualStomach = 58,
    ...
    /// <summary>
    ///     Pounces deal additional damage (max 2x) when unit has prey, as well as debuffing unit's dodge chance (max
    ///     -80%).
    /// </summary>
    HeavyPounce = 69,
    ...
    /// <summary>
    ///     Unit's movement is reduced by 25%, but movement penalties from prey are halved and minimum movement is raised
    ///     to 2.
    /// </summary>
    SlowMovement = 90,

    /// <summary>
    ///     Unit's movement is reduced by 45%, but movement penalties from prey are nullified and minimum movement is
    ///     raised to 2.
    /// </summary>
    VerySlowMovement = 91,

    /// <summary>
    ///     No healing is provided when absordbing this unit, and there is a 1/8 chance of being poisoned when attacking
    ///     this unit.
    /// </summary>
    Toxic = 92,
    ...
    /// <summary>
    ///     When killing another unit, this unit will recieve one of the following buffs: Valor, Mending, Fast, Shielded,
    ///     or Predation.
    /// </summary>
    TasteForBlood = 96,
    ...
    /// <summary>
    ///     Unit's maximum mana is increased by 50%, and units absorbing this unit will recover mana equivalent to 40% of
    ///     the digestion damage to this unit.
    /// </summary>
    ManaRich = 105,

    /// <summary>
    ///     When absorbing prey, this unit will recover mana equivalent to 40% of the digestion damage dealt, but healing
    ///     from the absorbed unit is reducued by 40%.
    /// </summary>
    ManaDrain = 106,

    /// <summary>
    ///     Unit deals 40% more damage with attacks, takes 25% less damage from melee and ranged attacks, and is half as likely
    ///     to miss,
    ///     but unit's movement is reduced by 20% and escape chance by 75%, and unit is 2.5x easier to vore. This trait is
    ///     spread to the predator when this unit is digested.
    /// </summary>
    CursedMark = 107,
    ...
    /// <summary>
    ///     Allows unit to use <b>Poison Spit</b>, an attack deals damage and inflicts a short, strong damage-over-time
    ///     effect once per battle.
    /// </summary>
    PoisonSpit = 110,
    ...
    /// <summary>
    ///     Unit deals up to 40% more damage with weapons based on how low target's health is, as well as an additional
    ///     10% per negative status effect the target has.
    /// </summary>
    SenseWeakness = 113,

    /// <summary>
    ///     Unit gains a stack of Blade Dance when landing a melee attack and loses a stack when hit with a melee attck.
    ///     Each stack boosts Strength by 2 and Agility by 1.
    /// </summary>
    BladeDance = 114,
    ...
    /// <summary>
    ///     Unit gains a stack of Tenacity when hit with or missing an attack and loses 5 stacks when landing an attack or
    ///     voring a target. Each stack boosts Strength, Agility and Voracity by 10%.
    /// </summary>
    Tenacious = 132,
    ...
    /// <summary>
    ///     Allows unit to use <b>Reanimate</b>, an attack that brings any unit back to life as the caster's summon, once
    ///     per battle.
    /// </summary>
    Reanimator = 146,
    ...
    ///     themselves to it or its close allies.
    /// </summary>
    Temptation = 151,
    ...
    //Hidden Traits
    /// <summary>
    ///     When an Army consists only of units with this trait, it moves undetected and can infiltrate the enemy by using
    ///     "exchange" on their village or a mercanary house.
    /// </summary>
    Infiltrator = 200,
    ...
    /// <summary>
    ///     Soon after this unit is digested, one of the new Units that come into being for the pred's race will be a
    ...
    //Hidden Cheat Traits
    /// <summary>
    ///     If a currupted unit is digested, the pred will build up corruption as a hidden status. Once corrupted prey
    ///     with a stat total equal to that of the pred has been digested, they are under control of the side of the
    ///     last-digested corrupted.
    /// </summary>
    Corruption = 350,

    /// <summary>
    ///     Soon after this unit dies, one of the new Units that come into being will be a reincarnation of them. The
    ///     reincarnation will also have this trait.
    /// </summary>
    InfiniteReincarnation = 351,

    /// <summary>
    ///     Soon after this unit is digested, one of the new Units that come into being as the pred's race will be a
    ///     reincarnation of them. The reincarnation will also have this trait.
    /// </summary>
    InfiniteTransmigration = 352,

    /// <summary>
    ///     If a possession unit is eaten, the pred will be possessed as a hidden status. Once possessed prey's stat total
    ///     plus the Preds corruption is equal to that of the pred, they are under control of the side of the last-eaten
    ///     possessed.
    /// </summary>
    Possession = 353,

    /// <summary>
    ///     A parasite prey will give the host CreateSpawn and set infection after digestion, host Takes minor damage on
    ///     prey absorption and major damage when creating spawn
    /// </summary>
    Parasite = 354,
    ...
    /// <summary>
    ///     Unit can only cock vore or unbirth pery if the prey is 1/3 the size of this unit, but Diminishment does not
    ///     fade while prey is inside this unit's cock or womb.
    /// </summary>
    TightNethers,
    ...
    /// <summary>
    ///     Cheat Trait: Unit is digested 75% slower, is immune to first 5 turns of digestion damage, takes 25% less
    ///     damage from melee and ranged attacks, gains +2 attacks of any type, +3 to all stats and +7 to 2 random stats on
    ///     level up and any stat can be boosted when levelling up.
    /// </summary>
    DivineBloodline = 243,
    ...
    /// <summary>
    ///     Cheat Trait: Unit gains random trait from prey upon absorption. When this occurs, unit loses this trait unless
    ///     unit had less than 5 traits beforehand.
    /// </summary>
    Assimilate = 252,

    /// <summary>
    ///     Cheat Trait: Unit gains random trait from prey upon absorption. If unit has already gained 3 traits this way,
    ///     the new trait replace the oldest trait.
    /// </summary>
    AdaptiveBiology = 253,
    ...
    /// <summary>
    ///     When this unit rubs the belly of a foe that has not been attacked in the last two turns, there is a chance for
    ///     that foe to be stunned or switch sides.
    /// </summary>
    SeductiveTouch = 266,
    ...
    /// <summary>
    ///     Every time digestion progresses, this unit steals one trait from each prey inside them, if only duplicates (or
    ///     non-assimilable traits) remain, they are turned into exp. Absorbtion steals any that are left.
    /// </summary>
    Extraction = 296,

    /// <summary>
    ///     Every time digestion progresses, this unit digests one level from each prey inside them, gaining its
    ///     experience value. If a unit hits level 0 this way, it dies if it was stil alive and cannot be revived.
    /// </summary>
    Annihilation = 297,
